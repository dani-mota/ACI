  ...
  return (
    <div className="rounded-lg border border-border bg-card p-4">
      <div className="flex items-start justify-between mb-3">
        <div>
          <div className="flex items-center gap-2">
            <h4 className="text-sm font-semibold text-foreground">{CONSTRUCT_LABELS[construct]}</h4>
          ...
          <div className="text-[11px] text-muted-foreground mt-0.5 flex items-center gap-3">
            <span>Team avg: <span className="font-mono text-muted-foreground">{Math.round(teamMean)}</span></span>
      ...
      <div className="space-y-3">
        {top3.map((rec) => {
          ...
          return (
            <div key={rec.memberId} className="rounded border border-border bg-card p-3">
              <div className="flex items-center justify-between mb-2">
                ...
                <div className="flex items-center gap-1 text-[10px]">
                  ...
                  <span className="font-mono font-semibold text-foreground">{rec.currentScore}</span>
                </div>
              </div>

              <div className="mb-2">
                <div className="text-[10px] text-muted-foreground mb-1">Development Potential</div>
...
export function DevelopmentPlan({ team, members }: DevelopmentPlanProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        <h4 className="text-sm font-semibold text-foreground mb-3">Priority Development Areas</h4>
      ...
      <div className="rounded-lg border border-border bg-card p-4">
        <h4 className="text-sm font-semibold text-foreground mb-3">Team Member Development Potential</h4>
          ...
          {memberPotentials.map(({ member, avgPotential }, idx) => (
            <div key={member.id} className="flex items-center gap-3 py-1.5">
              ...
              <div className="min-w-[120px]">
                <div className="text-xs text-foreground font-medium">{member.name}</div>
