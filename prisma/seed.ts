  ...
  for (const cand of spec.candidates) {
    ...
    await prisma.prediction.create({
      data: {
        ...
        supervisionScore: Math.round((mc * 0.3) + (prl * 0.25) + (scores.ETHICAL_JUDGMENT * 0.25) + (scores.EXECUTIVE_CONTROL * 0.2)),
        supervisionFactors: {
          metacognition: mc,
          proceduralReliability: prl,
          ethicalJudgment: scores.ETHICAL_JUDGMENT,
          executiveControl: scores.EXECUTIVE_CONTROL,
        },
  ...
  roles: [
    {
      ...
      complexityLevel: 5,
      weights: {
        FLUID_REASONING: 15, EXECUTIVE_CONTROL: 7, COGNITIVE_FLEXIBILITY: 9,
        METACOGNITIVE_CALIBRATION: 7, LEARNING_VELOCITY: 9,
        SYSTEMS_DIAGNOSTICS: 18, PATTERN_RECOGNITION: 7, QUANTITATIVE_REASONING: 9,
        SPATIAL_VISUALIZATION: 5, MECHANICAL_REASONING: 3,
        PROCEDURAL_RELIABILITY: 5, ETHICAL_JUDGMENT: 6,
      },
    ...
    },
    {
      ...
      complexityLevel: 5,
      weights: {
        FLUID_REASONING: 11, EXECUTIVE_CONTROL: 6, COGNITIVE_FLEXIBILITY: 4,
        METACOGNITIVE_CALIBRATION: 6, LEARNING_VELOCITY: 5,
        SYSTEMS_DIAGNOSTICS: 9, PATTERN_RECOGNITION: 7, QUANTITATIVE_REASONING: 17,
        SPATIAL_VISUALIZATION: 11, MECHANICAL_REASONING: 13,
        PROCEDURAL_RELIABILITY: 7, ETHICAL_JUDGMENT: 4,
      },
    ...
    },
    {
      ...
      complexityLevel: 5,
      weights: {
        FLUID_REASONING: 9, EXECUTIVE_CONTROL: 9, COGNITIVE_FLEXIBILITY: 7,
        METACOGNITIVE_CALIBRATION: 6, LEARNING_VELOCITY: 7,
        SYSTEMS_DIAGNOSTICS: 14, PATTERN_RECOGNITION: 16, QUANTITATIVE_REASONING: 11,
        SPATIAL_VISUALIZATION: 5, MECHANICAL_REASONING: 4,
        PROCEDURAL_RELIABILITY: 7, ETHICAL_JUDGMENT: 5,
      },
    ...
    },
    {
      ...
      complexityLevel: 4,
      weights: {
        FLUID_REASONING: 7, EXECUTIVE_CONTROL: 7, COGNITIVE_FLEXIBILITY: 6,
        METACOGNITIVE_CALIBRATION: 11, LEARNING_VELOCITY: 6,
        SYSTEMS_DIAGNOSTICS: 9, PATTERN_RECOGNITION: 9, QUANTITATIVE_REASONING: 14,
        SPATIAL_VISUALIZATION: 5, MECHANICAL_REASONING: 5,
        PROCEDURAL_RELIABILITY: 16, ETHICAL_JUDGMENT: 5,
      },
    ...
    },
    {
      ...
      complexityLevel: 3,
      weights: {
        FLUID_REASONING: 5, EXECUTIVE_CONTROL: 7, COGNITIVE_FLEXIBILITY: 5,
        METACOGNITIVE_CALIBRATION: 6, LEARNING_VELOCITY: 13,
        SYSTEMS_DIAGNOSTICS: 7, PATTERN_RECOGNITION: 6, QUANTITATIVE_REASONING: 7,
        SPATIAL_VISUALIZATION: 16, MECHANICAL_REASONING: 13,
        PROCEDURAL_RELIABILITY: 11, ETHICAL_JUDGMENT: 4,
      },
  ...
  roles: [
    {
      ...
      weights: {
        ...
        METACOGNITIVE_CALIBRATION: 6, LEARNING_VELOCITY: 9,
        SYSTEMS_DIAGNOSTICS: 15, PATTERN_RECOGNITION: 8, QUANTITATIVE_REASONING: 7,
        SPATIAL_VISUALIZATION: 13, MECHANICAL_REASONING: 8,
    ...
    },
    {
      ...
      complexityLevel: 5,
      weights: {
        FLUID_REASONING: 7, EXECUTIVE_CONTROL: 11, COGNITIVE_FLEXIBILITY: 7,
        METACOGNITIVE_CALIBRATION: 7, LEARNING_VELOCITY: 7,
        SYSTEMS_DIAGNOSTICS: 9, PATTERN_RECOGNITION: 16, QUANTITATIVE_REASONING: 14,
        SPATIAL_VISUALIZATION: 5, MECHANICAL_REASONING: 5,
        PROCEDURAL_RELIABILITY: 7, ETHICAL_JUDGMENT: 5,
      },
    ...
    },
    {
      ...
      complexityLevel: 5,
      weights: {
        FLUID_REASONING: 18, EXECUTIVE_CONTROL: 6, COGNITIVE_FLEXIBILITY: 9,
        METACOGNITIVE_CALIBRATION: 7, LEARNING_VELOCITY: 11,
        SYSTEMS_DIAGNOSTICS: 7, PATTERN_RECOGNITION: 9, QUANTITATIVE_REASONING: 17,
    ...
    },
    {
      ...
      complexityLevel: 5,
      weights: {
        FLUID_REASONING: 9, EXECUTIVE_CONTROL: 9, COGNITIVE_FLEXIBILITY: 5,
        METACOGNITIVE_CALIBRATION: 6, LEARNING_VELOCITY: 6,
        SYSTEMS_DIAGNOSTICS: 16, PATTERN_RECOGNITION: 9, QUANTITATIVE_REASONING: 14,
        SPATIAL_VISUALIZATION: 7, MECHANICAL_REASONING: 11,
        PROCEDURAL_RELIABILITY: 4, ETHICAL_JUDGMENT: 4,
      },
    ...
    },
    {
      ...
      weights: {
        FLUID_REASONING: 7, EXECUTIVE_CONTROL: 7, COGNITIVE_FLEXIBILITY: 6,
        METACOGNITIVE_CALIBRATION: 10, LEARNING_VELOCITY: 7,
        SYSTEMS_DIAGNOSTICS: 9, PATTERN_RECOGNITION: 13, QUANTITATIVE_REASONING: 9,
        SPATIAL_VISUALIZATION: 4, MECHANICAL_REASONING: 7,
        PROCEDURAL_RELIABILITY: 15, ETHICAL_JUDGMENT: 6,
      },
  ...
  roles: [
    {
      ...
      complexityLevel: 5,
      weights: {
        FLUID_REASONING: 17, EXECUTIVE_CONTROL: 6, COGNITIVE_FLEXIBILITY: 9,
        METACOGNITIVE_CALIBRATION: 8, LEARNING_VELOCITY: 11,
        SYSTEMS_DIAGNOSTICS: 8, PATTERN_RECOGNITION: 8, QUANTITATIVE_REASONING: 17,
        SPATIAL_VISUALIZATION: 4, MECHANICAL_REASONING: 2,
        PROCEDURAL_RELIABILITY: 5, ETHICAL_JUDGMENT: 5,
      },
    ...
    },
    {
      ...
      complexityLevel: 5,
      weights: {
        FLUID_REASONING: 21, EXECUTIVE_CONTROL: 5, COGNITIVE_FLEXIBILITY: 10,
        METACOGNITIVE_CALIBRATION: 11, LEARNING_VELOCITY: 14,
    ...
    },
    {
      ...
      complexityLevel: 4,
      weights: {
        FLUID_REASONING: 11, EXECUTIVE_CONTROL: 11, COGNITIVE_FLEXIBILITY: 13,
        METACOGNITIVE_CALIBRATION: 8, LEARNING_VELOCITY: 9,
        SYSTEMS_DIAGNOSTICS: 15, PATTERN_RECOGNITION: 9, QUANTITATIVE_REASONING: 7,
        SPATIAL_VISUALIZATION: 3, MECHANICAL_REASONING: 2,
        PROCEDURAL_RELIABILITY: 7, ETHICAL_JUDGMENT: 5,
      },
    ...
    },
    {
      ...
      weights: {
        FLUID_REASONING: 9, EXECUTIVE_CONTROL: 9, COGNITIVE_FLEXIBILITY: 7,
        METACOGNITIVE_CALIBRATION: 6, LEARNING_VELOCITY: 7,
        SYSTEMS_DIAGNOSTICS: 15, PATTERN_RECOGNITION: 11, QUANTITATIVE_REASONING: 17,
        SPATIAL_VISUALIZATION: 3, MECHANICAL_REASONING: 2,
        PROCEDURAL_RELIABILITY: 9, ETHICAL_JUDGMENT: 5,
      },
      cutline: { tech: 70, behav: 60, lv: 55 },
    },
    {
      ...
      complexityLevel: 4,
      weights: {
        FLUID_REASONING: 11, EXECUTIVE_CONTROL: 13, COGNITIVE_FLEXIBILITY: 8,
        METACOGNITIVE_CALIBRATION: 7, LEARNING_VELOCITY: 8,
        SYSTEMS_DIAGNOSTICS: 17, PATTERN_RECOGNITION: 8, QUANTITATIVE_REASONING: 9,
        SPATIAL_VISUALIZATION: 3, MECHANICAL_REASONING: 2,
        PROCEDURAL_RELIABILITY: 9, ETHICAL_JUDGMENT: 5,
      },
